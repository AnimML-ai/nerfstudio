...
class MaskNerfactoField(Field):
    ...
    def get_outputs(
        ...
        segmentation = self.mlp_semantics(semantics_input).view(*outputs_shape, -1).to(directions)
        outputs.update({FieldHeadNames.SEMANTICS: segmentation})
